...
it('Capsule source analysis', async function () {
    ...
    // process.stdout.write(JSON.stringify(capsule1, null, 4))
    expect(JSON.parse(JSON.stringify(capsule1))).toMatchSnapshot()

    // process.stdout.write(JSON.stringify(capsule2, null, 4))
    expect(JSON.parse(JSON.stringify(capsule2))).toMatchSnapshot()
})
