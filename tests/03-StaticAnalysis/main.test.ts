...
it('Capsule source analysis', async function () {
    ...
    expect(capsule1.cst.cacheBustVersion).toBe(9)
    ...
    expect(capsule2.cst.cacheBustVersion).toBe(9)
    ...
    expect(capsule2.definition['#@stream44.studio/encapsulate/spine-contracts/CapsuleSpineContract.v0']['#'].mappedCapsule.value.capsuleSourceLineRef).toMatch(/main\.test\.ts:69$/)
